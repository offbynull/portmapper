...
public final class CreateTcpIoRequest implements IoRequest {
    ...
    public CreateTcpIoRequest(Bus responseBus, InetAddress sourceAddress, InetAddress destinationAddress, int destinationPort) {
