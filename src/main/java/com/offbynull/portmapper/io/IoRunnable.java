...
import com.offbynull.portmapper.io.internalmessages.CreateProcessIoRequest;
 ...
 * @author User
 */
final class IoRunnable implements Runnable {
    ...
    private void processMessage(Object msg) throws IOException {
        if (msg instanceof CreateUdpIoRequest) {
        ...
        } else if (msg instanceof CreateProcessIoRequest) {
            CreateProcessIoRequest req = (CreateProcessIoRequest) msg;
            Bus responseBus = req.getResponseBus();
        ...
        } else if (msg instanceof DestroyResourceIoRequest) {
            DestroyResourceIoRequest req = (DestroyResourceIoRequest) msg;
            ...
            try {
                ...
                channel.close();
                responseBus.send(new DestroyResourceIoResponse(id));
            } catch (RuntimeException re) {
                if (responseBus != null) {
