...
import com.offbynull.portmapper.mappers.natpmp.externalmessages.NatPmpRequest;
...
final class InternalUtils {
    ...
    static final class UdpRequest {
        ...
        private NatPmpRequest sendMsg;
        private NatPmpResponse respMsg;
        ...
        NatPmpRequest getSendMsg() {
            return sendMsg;
        }

        void setSendMsg(NatPmpRequest sendMsg) {
            this.sendMsg = sendMsg;
        }

        NatPmpResponse getRespMsg() {
            return respMsg;
        }

        void setRespMsg(NatPmpResponse respMsg) {
