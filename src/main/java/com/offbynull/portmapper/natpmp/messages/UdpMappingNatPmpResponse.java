 ...
 */
public final class UdpMappingNatPmpResponse implements NatPmpResponse {
     ...
     */
    public UdpMappingNatPmpResponse(byte[] data) {
     ...
     */
    public UdpMappingNatPmpResponse(int internalPort, int externalPort, long lifetime) {
