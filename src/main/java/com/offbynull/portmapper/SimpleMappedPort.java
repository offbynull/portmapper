 ...
 */
public final class SimpleMappedPort {
     ...
     */
    public SimpleMappedPort(int internalPort, int externalPort, InetAddress externalAddress, PortType portType, long duration) {
